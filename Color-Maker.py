...
def get_red(slider_value):
    """Turn current slider value for red into a hex value and update color. 18 The scale value is passed automatically when the scale is moved calling the get_red function."""
    global red_value
...
def get_green(slider_value):
    """Turn current slider value for green into a hex value and update color.  The scale value is passed automatically when the scale is moved calling the get_green function."""
    global green_value
    #Turn the slider value into an int and hex value. Strip leading chars so only two remain
...
def get_blue(slider_value):
    """Turn current slider value for blue into a hex value and update color.The scale value is passed automatically when the scale is moved calling the get_blue function."""
    global blue_value
    #Turn the slider value into an int and hex value. Strip leading chars so only two remain
...
def store_color():
    ...
    #Move the radio button stored colors_ to the next value if available 122 if stored_color.get() < 5:
